...
class IntYield(PhysicsModel):
    ...
    def doParametersOfInterest(self):
        ...
        self.modelBuilder.doVar("rI[1,0,50]")
        self.modelBuilder.doVar("mu[1,0.5,1.5]")
        self.modelBuilder.doVar("mu_V[1,0.5,1.5]")

        self.modelBuilder.factory_( "expr::ggH_s_func(\"(@0 - @1)\", mu, rI)")
        self.modelBuilder.factory_(  "expr::ggH_si_func(\"@0\", rI)")

        self.modelBuilder.factory_( "expr::qqH_s_func(\"@0\", mu_V)")
        self.modelBuilder.factory_( "expr::vh_s_func(\"@0\", mu_V)")

        self.modelBuilder.doSet("POI","mu,rI,mu_V")
