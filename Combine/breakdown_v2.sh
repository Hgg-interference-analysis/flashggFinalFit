...
--setParameters gamma=1,MH=125.38 --setParameterRanges gamma=0,25 --X-rtd FITTER_NEW_CROSSING_ALGO \
...
--floatOtherPOIs 1 -t -1 -n _width.total -P gamma --algo grid --freezeParameters MH --points 26 --alignEdges 1 -v 1 --setParameters gamma=1,MH=125.38 \
...
--setParameters gamma=1,MH=125.38 --setParameterRanges gamma=0,25 \
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid -n _width.freeze_thu_phoid
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg -n _width.freeze_thu_phoid_brhgg
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg,lumi -n _width.freeze_thu_phoid_brhgg_lumi
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg,lumi,sf -n _width.freeze_thu_phoid_brhgg_lumi_sf
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg,lumi,sf,resoshift -n _width.freeze_thu_phoid_brhgg_lumi_sf_resoshift
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg,lumi,sf,resoshift,trigger -n _width.freeze_thu_phoid_brhgg_lumi_sf_resoshift_trigger
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg,lumi,sf,resoshift,trigger,scale -n _width.freeze_thu_phoid_brhgg_lumi_sf_resoshift_trigger_scale
...
--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants \
--X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2  --snapshotName MultiDimFit \
--freezeNuisanceGroups THU,phoid,brhgg,lumi,sf,resoshift,trigger,scale,smear -n _width.freeze_thu_phoid_brhgg_lumi_sf_resoshift_trigger_scale_smear
