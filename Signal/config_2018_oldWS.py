...
signalScriptCfg = {
    ...
    'scalesCorr': 'MaterialCentralBarrel,MaterialOuterBarrel,MaterialForward,FNUFEB,FNUFEE,ShowerShapeHighR9EE,ShowerShapeHighR9EB,ShowerShapeLowR9EE,ShowerShapeLowR9EB', # correlated across years
