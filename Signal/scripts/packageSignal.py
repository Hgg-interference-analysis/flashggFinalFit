...
for ext in opt.exts.split(","): fNames[ext] = glob.glob("outdir_%s/signalFit/output/CMS-HGG_sigfit_final%s_*_%s.root"%(ext,opt.year,opt.cat))
...
print("about to do: packagedWS.Write()")
packagedWS.Write()
#print("about to do: packagedWS.Delete()")
#packagedWS.Delete()
#f.Delete()
#print("about to do: exiting")
#f.Close()
