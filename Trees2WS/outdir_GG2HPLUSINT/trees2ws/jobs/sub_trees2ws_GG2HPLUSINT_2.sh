...
python /afs/cern.ch/work/r/rgargiul/CMSSW_10_2_13/src/flashggFinalFit/Trees2WS/trees2ws.py --inputConfig config.py --inputTreeFile /eos/user/a/amkrishn/hggWidth/mcNtuples/condor_output/forRuben/2018_sig_plus_ggInterference/output_GluGluHToGG_sig_plus_int_M130_13TeV.root --productionMode ggh --year 2018 --inputMass 130 --doSystematics
