...
# PDF weight
theory_systematics.append( {'name':'pdfWeight_0', 'title':'CMS_hgg_pdfWeight_0', 'type':'factory','prior':'lnN','correlateAcrossYears':1,'tiers':['shape']} )
...
#                #{'name':'Geant4','title':'Geant4','type':'signal_shape','mode':'scalesGlobal','mean':'0.0','sigma':'0.0005'},
                ...
                {'name':'IntNorm','title':'IntNorm','type':'signal_shape','mode':'scalesCorr','mean':'0.0','sigma':'1.0'}
              ]
