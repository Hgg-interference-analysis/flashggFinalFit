...
python3 /afs/cern.ch/work/r/rgargiul/CMSSW_14_1_0_pre4/src/flashggFinalFit/Datacard/makeYields.py --cat UntaggedTag_2 --procs GG2H,VBF,GG2HPLUSINT,vh --ext 2025-02-13_2016postVFP_xsec --mass 125 --inputWSDirMap 2016postVFP=/eos/cms/store/group/phys_higgs/cmshgg/rgargiul/ws_2016postVFP --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --skipZeroes --doSystematics
