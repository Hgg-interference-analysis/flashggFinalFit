...
if [[ $STEP == "yields" ]]; then
    ...
    echo "linking Models/signal to ../../Signal/outdir_packaged_oldws"
    ln -s ../../Signal/outdir_packaged_oldws signal
    echo "linking Models/background to ../../Background/outdir_2024-10-06_oldws/"
